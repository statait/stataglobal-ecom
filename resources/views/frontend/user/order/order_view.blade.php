...
<div class="body-content">
	<div class="container">
       ...
       <tr>
                ...
                <td class="col-md-3">
                  <label for=""> TK {{ $order->amount }}</label>
                </td>
        ...
        @endif
         ...
         <td class="col-md-1">
          <a href="{{ url('user/order_details/'.$order->id ) }}" class="btn btn-sm btn-primary" style="margin-top: 5px; margin-bottom: 5px;"><i class="fa fa-eye"></i> View</a>

           <a target="_blank" href="{{ url('user/invoice_download/'.$order->id ) }}" class="btn btn-sm btn-danger"><i class="fa fa-download" style="color: white; "></i> Invoice </a>
