								...
								<div class="row">
									...
									<div class="col-sm-9">
										<div class="stock-box">
											...
											<span class="value">Out of Stock <span style="color: black"><strong>(Pre-Order)</strong></span></span>
											@else
							...
							<div class="quantity-container info-container">
								<div class="row">
									...
									<div class="col-sm-7">
                                        ...
                                        <button type="submit" onclick="buyNow()" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i> BUY NOW</button>
									</div>
