	 ...
	 @enderror 
			...
			<div class="col-md-4">
				...
				<div class="form-group">
					...
					<div class="controls">
						<input type="text" name="alt_text" class="form-control" required="" value="{{ $products->alt_text }}">
					 </div>
						 </div>
...
<div class="row"> <!-- start 7th row  -->
			<div class="col-md-6">
				...
				<div class="form-group">
					...
					<div class="controls">
			<textarea name="long_descp" id="textarea" class="form-control" placeholder="">{{$products->long_descp}}</textarea>     
					  </div>
				</div>
			...
			<div class="controls">
			 <input type="text" name="short_descp" class="form-control" data-role="tagsinput" required="" value="{{ $products->short_descp }}">
			 @error('short_descp') 
			 <span class="text-danger">{{ $message }}</span>
			 @enderror
					  </div>
...
<div class="row"> <!-- start 8th row  -->
			<div class="col-md-4">
				<div class="form-group">
					...
					<div class="controls">
			 <input type="text" name="video_link" class="form-control" value="{{ $products->video_link }}">
			 @error('video_link') 
			 <span class="text-danger">{{ $message }}</span>
			 @enderror
				   </div>
			...
			<div class="col-md-4"> 
				<div class="form-group">
					...
					<div class="controls">
				 <input type="text" value="{{$products->c_meta_title}}" name="c_meta_title" class="form-control" > 
			...
			<div class="col-md-4"> 
				<div class="form-group">
					...
					<div class="controls">
				 <input type="text"  name="c_meta_description" value="{{$products->c_meta_description}}" class="form-control" > 
...
<div class="col-md-6">
		...
		<div class="controls">
			<fieldset>
		 <input type="checkbox" id="checkbox_2" name="new" value="1" {{ $products->new == 1 ? 'checked': '' }}>
				<label for="checkbox_2">New</label>
			</fieldset>
			<fieldset>
				<input type="checkbox" id="checkbox_3" name="sale" value="1" {{ $products->sale == 1 ? 'checked': '' }}>
				<label for="checkbox_3">Sale</label>
			</fieldset>
		</div>
	</div>
</div>
...
<div class="col-md-6">
	<div class="form-group">
		...
		<div class="controls">
			<fieldset>
				<input type="checkbox" id="checkbox_4" name="best_seller" value="1" {{ $products->best_seller == 1 ? 'checked': '' }}>
				<label for="checkbox_4">Best Seller</label>
			</fieldset>
			<fieldset>
				<input type="checkbox" id="checkbox_5" name="combo" value="1" {{ $products->combo == 1 ? 'checked': '' }}>
...
<div class="card">
  <img src="{{ asset($products->product_thambnail) }}" class="card-img-top" style="height: 200px; width: 200px;">
  <div class="card-body">
