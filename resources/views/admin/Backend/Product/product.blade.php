...
<div class="row"> <!-- start 7th row  -->
	...
	<div class="col-md-4">
			...
			<div class="form-group">
				<h6>Features<span class="text-danger">*</span></h6>
				<div class="controls">
		 <input type="text" name="short_descp" class="form-control" value="STATA Smart App,Password,RFID Card,Generate Guest OTP,Traditional Key" data-role="tagsinput" required="">
		 @error('short_descp') 
		 <span class="text-danger">{{ $message }}</span>
		 @enderror
				  </div>
...
<div class="row"> <!-- start 8th row  -->
	...
	<textarea name="long_descp" id="textarea" class="form-control" required placeholder="Long description"></textarea>     
			...
			<div class="col-md-4">
				<div class="form-group">
		   <h6>Video Link<span class="text-danger">*</span></h6>
		   <div class="controls">
			...
			<div class="form-group">
				...
				<div class="controls">
					<fieldset>
						...
						<label for="checkbox_2">Sale</label>
					</fieldset>
				</div>
			</div>	 
