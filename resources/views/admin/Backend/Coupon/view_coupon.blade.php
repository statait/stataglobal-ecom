...
<!--   ------------ Add Category Page -------- -->
          ...
          <div class="col-4">
			 ...
			 <div class="box">
				<div class="box-header with-border">
				  <h6 class="box-title">Add Coupon </h6>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
					<div class="table-responsive">
 ...
 <form method="post" action="{{ route('coupon.store') }}" >
	 ...
	 <div class="form-group">
		<h6>Coupon Name  <span class="text-danger">*</span></h6>
		<div class="controls">
	...
	<div class="form-group">
		<h6>Coupon Discount(%) <span class="text-danger">*</span></h6>
		<div class="controls">
	...
	<div class="form-group">
		<h6>Coupon Validity Date  <span class="text-danger">*</span></h6>
		<div class="controls">
