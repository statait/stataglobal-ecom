...
<div class="container-full">
		...
		<div class="icon bg-primary-light rounded w-60 h-60">
			<i class="text-primary mr-0 font-size-36 mdi mdi-cash-100"></i>
		</div>
		<div>
			<p class="text-mute mt-20 mb-0 font-size-16">Today's Sale</p>
			<h3 class="text-white mb-0 font-weight-500">TK {{ $today  }} <small class="text-success"><i class="fa fa-caret-up"></i> BDT</small></h3>
		</div>
	</div>
</div>
</div>
...
<div class="box overflow-hidden pull-up">
	<div class="box-body">							
		<div class="icon bg-warning-light rounded w-60 h-60">
			<i class="text-warning mr-0 font-size-36 mdi mdi-cash-multiple"></i>
		</div>
		<div>
			<p class="text-mute mt-20 mb-0 font-size-16">Monthly Sale </p>
			<h3 class="text-white mb-0 font-weight-500">TK {{ $month }} <small class="text-success"><i class="fa fa-caret-up"></i> BDT</small></h3>
		</div>
	</div>
</div>
</div>
...
<div class="box overflow-hidden pull-up">
	<div class="box-body">							
		<div class="icon bg-info-light rounded w-60 h-60">
			<i class="text-info mr-0 font-size-36 mdi mdi-cash-multiple"></i>
		</div>
		<div>
			<p class="text-mute mt-20 mb-0 font-size-16">Yearly Sale </p>
			<h3 class="text-white mb-0 font-weight-500">TK {{ $year }} <small class="text-success"><i class="fa fa-caret-up"></i> BDT</small></h3>
		</div>
	</div>
</div>
</div>
...
<div class="box overflow-hidden pull-up">
	<div class="box-body">							
		<div class="icon bg-danger-light rounded w-60 h-60">
			<i class="text-danger mr-0 font-size-36 mdi mdi-reorder-horizontal"></i>
		</div>
		<div>
