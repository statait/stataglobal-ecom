...
class CartController extends Controller
{
    ...
    public function AddCustomizeToCart(Request $request, $productId, $frameId){
        ...
        if ($jsonData === false) {
			...
			if ($data === null) {
                ...
                return response()->json(['success' => 'Customized Product Added Successfully on Your Cart']);
